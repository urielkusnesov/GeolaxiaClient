...
public class WhitePlanet extends Planet {
    public WhitePlanet(int id, String name, Player conqueror, int metal, int crystal, int darkMatter, int energy, boolean isOrigin, geolaxia.geolaxia.Model.SolarSystem solarSystem, int positionX, int positionY, int positionZ, int planetType) {
