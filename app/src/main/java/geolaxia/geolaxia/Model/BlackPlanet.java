...
public class BlackPlanet extends Planet {
    public BlackPlanet(int id, String name, int order, Player conqueror, int metal, int crystal, int darkMatter, int energy, boolean isOrigin, geolaxia.geolaxia.Model.SolarSystem solarSystem, int positionX, int positionY, int positionZ, int planetType) {
    ...
    public BlackPlanet(Planet planet){
    ...
    @Override
    public int getImage(){
        return R.drawable.planeta_oscuro;
    }
}
